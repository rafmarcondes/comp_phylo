...
updateFreq = 1   # Frequency of screen updates to make sure chain is running.
...
As "data" (the number of draws from the binomial) is subtracted, the confidence interval broadens
 (to (0.338095,0.741624) at n=20), and as data is added it narrows down to around the true 
 value of p ( (0.495028,0.508369) at n=20000)
